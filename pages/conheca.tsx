...
const Conheca: React.FC = () => {
    return(
        <>
            <Head>
                <title>Datanow - Conheça</title>
                <meta name="Conheca" content="Página informando sobre a empresa"/>
            </Head>
            <div className="bg-azulEscuro h-full">
                <div className="bg-azulEscuro px-4 py-3  lg:px-72 xl:px-96 ">
                    <h2 className="font-bold text-white text-4xl xl:text-5xl text-center my-4">Conheça</h2>
                    
                    <div className="mb-4 md:max-w-screen-md xl:py-20 xl:max-w-screen-lg xl:text-xl xl:ml-8">
